...
dirs_eems <- "C:/Users/jc486631/OneDrive - James Cook University/Melbourne/Melbourne/Analysis/2021/eems/TSI-EEMS/results/tsi-eems-deme200"

#path and dirs attempt v2


```
Plotting the TSI data
```{r}
eems.plots(mcmcpath = dirs_eems,
           plotpath = path_eems, "tsi-params-deme200",
...
#this code works.
eems.plots(mcmcpath = dirs_eems, plotpath = paste0(path_eems, "All-plots"), longlat = T,
